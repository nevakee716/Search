      ...
      if (error === null) {
        ...
        cwApi.CwAsyncLoader.load("angular", function () {
          ...
          loader.loadControllerWithTemplate("cwLayoutSearch", $container, templatePath, function ($scope, $sce, $http) {
            ...
            function doSearch() {
              var i = 0,
                jsonFile = cwApi.getIndexViewDataUrl(that.viewSchema.ViewName);
              disableInput();
              $scope.data = [];
              // reload data
            ...
            $scope.setOptionsFromConfiguration = function () {
              var i = 0,
                j,
                node,
                propertiesScriptName,
                scopeJson = that.options.CustomOptions["search-scope"];
